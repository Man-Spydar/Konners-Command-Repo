...
Commands for Azure cloud resources and identity services in US Government / GCC High tenants.

---

## Quick Reference
- [Microsoft Graph](#microsoft-graph)
  - [Install/Import Microsoft Graph SDK](#microsoft-graph-powershell-sdk)
  - [Connect to Microsoft Graph (US Gov)](#connect-to-microsoft-graph-us-gov)
  - [Verify Graph connection context](#verify-graph-connection-context)
- [Azure AD (Entra ID – Legacy Module)](#azure-ad-entra-id--legacy-module)
  - [Install/Import AzureAD](#azuread-module-import--install)
  - [Connect to Azure AD (US Gov)](#connect-to-azure-ad-us-gov)
- [Exchange Online](#exchange-online)
  - [Install/Import Exchange Online Management](#exchange-online-management-module)
  - [Connect to Exchange Online (GCC High)](#connect-to-exchange-online-gcc-high)
